...
RSpec.describe 'AWS Bedrock Translation' do
  ...
  let(:aws_credentials_set?) { Aws::BedrockRuntime::Client.new.config.credentials.set? rescue false }
  ...
  describe 'real world test' do
    ...
    context 'command' do
      ...
      it 'works' do # rubocop:disable RSpec/MultipleExpectations
        skip 'AWS Bedrock SDK credentials not set' unless aws_credentials_set?
        ...
        in_test_app_dir do
          ...
          run_cmd 'translate-missing', '--backend=bedrock'
